...
SolARModuleManagerOpencvNonFree::SolARModuleManagerOpencvNonFree(const char *iniFile)
{
    ...
    #else
    xpcf_xmlPath=pt.get<std::string>("NonFreeOpenCV.xmlReleasePath");
    xpcf_libPath=pt.get<std::string>("NonFreeOpenCV.libReleasePath");
    #endif
